        ...
        <div className="collapse navbar-collapse" id="navbarsExample04">
          <ul className="navbar-nav ml-auto margin-nav">
            <li className="nav-item active">
                <Link to="/lists" className="unset-anchor nav-link">Grocery Lists</Link>
            </li>
            <li className="nav-item active">
                <Link to="/full-list" className="unset-anchor nav-link">Full List</Link>
            </li>
            {/* <li className="nav-item active dropdown">
              ...
              <div className="dropdown-menu" aria-labelledby="examples-dropdown">
                ...
                <div className="dropdown-item"><Link to="/pending" className="unset-anchor nav-link active">Pending Friend Requests</Link></div>
